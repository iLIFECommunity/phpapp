	  ...
	  <div id="login-page">
		  ...
		  <form class="form-login" id="loginform" action="{{route('login')}}"  method="post" >
              ...
              <ul>
                    ...
                    <li ><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true">{{ $error }}</span></li>
                    @endforeach
                </ul>
		              ...
		              <div class="modal-dialog">
		                  <div class="modal-content">
		                      ...
		                      <div class="modal-body">
		                          ...
		                          <input type="text" name="emai1l" placeholder="Email1" autocomplete="off" class="form-control placeholder-no-fix">
